    ...
    <div className="relative">
      ...
      <div className="h-screen bg-[#00a774] shadow-lg flex flex-col items-center w-25">
        <nav className="flex flex-col gap-4 mt-10">
          <SidebarIcon icon={<LayoutDashboard size={32} />} tooltip="Dashboard" />
...
const SidebarIcon = ({ icon, tooltip }) => (
  ...
  >
    ...
    <span className="absolute left-11 top-9 bg-white text-black text-sm rounded-b-md rounded-tr-md py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity shadow-lg">
      {tooltip}
    </span>
  </div>
);
